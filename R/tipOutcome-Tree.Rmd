...
lassoT <- predict(lasso_cv,trainSample[,-which(names(trainSample) %in% c("tipOutcome"))],lasso_cv$ambda.1se)
lassoV <- predict(lasso_cv,validateSample[,-which(names(validateSample) %in% c("tipOutcome"))],lasso_cv$ambda.1se)
