...
kprep <- select(na.omit(data), company, trip_miles, trip_seconds, fare, trip_total, extras, payment_type, pickup_area, dropoff_area)
...
gowclean<-kprep[sample(nrow(kprep), 7000), ]
...
gownew<-gownew[sample(nrow(gownew), 7000), ]
#gownew$extras<-NULL
