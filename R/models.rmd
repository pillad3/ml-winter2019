...
We will use k-means clustering to see how many unique sets of riders may exist in Chicago. We will first copy our dataframe into a new df that has been rescaled.
...
```{r}
big.tree = rpart(tips~., data=trainSample, control=rpart.control(minsplit=1000,cp=0.001,xval=10))
