...
dfClean2$PercentUnempPickupF <- dfClean2$PercentUnempPickup
dfClean2$PercentUnempDropoffF <- dfClean2$PercentUnempDropoff
Thres1=5
Thres2=10
Thres3=15
Thres4=20
...
#levels(dfClean2$PercentUnempPickupF) <- c("0-5%",">5-10%",">10-15%",">15-20%",">20-25%",">25%")
#levels(dfClean2$PercentUnempDropoffF) <- c("0-5%",">5-10%",">10-15%",">15-20%",">20-25%",">25%")
...
for (i in 1:2){
  ...
  levels(CurrentColumn)[as.numeric(CurrentColumn)<=Thres1]="0-5%"

  levels(CurrentColumn)[as.numeric(CurrentColumn)>Thres1 & as.numeric(CurrentColumn)<=Thres2 ]=">5-10%"

  levels(CurrentColumn)[as.numeric(CurrentColumn)>Thres2 & as.numeric(CurrentColumn)<=Thres3 ]=">10-15%"

  levels(CurrentColumn)[as.numeric(CurrentColumn)>Thres3 & as.numeric(CurrentColumn)<=Thres4 ]=">15-20%"

  levels(CurrentColumn)[as.numeric(CurrentColumn)>Thres4 & as.numeric(CurrentColumn)<=Thres5 ]=">20-25%"

  levels(CurrentColumn)[as.numeric(CurrentColumn)>Thres5]=">25%"

  dfClean2[[colsToChange[i]]]=CurrentColumn                    #Plug-back to the data.frame
}

******Go back to hw4 code and add a table that matches factors to their numeric equivalent
******
